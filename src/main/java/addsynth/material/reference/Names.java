...
public final class Names {
  ...
  public static final ResourceLocation AMETHYST_SHARD = new ResourceLocation(ADDSynthMaterials.MOD_ID, "amethyst_shard");
  ...
  public static final ResourceLocation  DIAMOND_SHARD = new ResourceLocation(ADDSynthMaterials.MOD_ID, "diamond_shard");
  public static final ResourceLocation  EMERALD_SHARD = new ResourceLocation(ADDSynthMaterials.MOD_ID, "emerald_shard");
  ...
  public static final ResourceLocation   QUARTZ_SHARD = new ResourceLocation(ADDSynthMaterials.MOD_ID, "quartz_shard");
