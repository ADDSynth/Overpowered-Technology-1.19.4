...
public final class CircuitFabricatorGui extends GuiEnergyBase<TileCircuitFabricator, CircuitFabricatorContainer> {
  ...
  protected final void renderBg(PoseStack matrix, float partialTicks, int mouseX, int mouseY){
    ...
    if(length >= 1){
      ...
      recipe_ingredients.drawIngredient(itemRenderer, matrix, 0, leftPos + ingredient_draw_x[0], topPos + ingredient_draw_y[0]);
    }
    if(length >= 2){
      draw(matrix, arrow_draw_x[1], arrow_draw_y[0], down_arrow_texture_x, down_arrow_texture_y, 14, 8, 28, 16);
      recipe_ingredients.drawIngredient(itemRenderer, matrix, 1, leftPos + ingredient_draw_x[1], topPos + ingredient_draw_y[1]);
    }
    if(length >= 3){
      draw(matrix, arrow_draw_x[2], arrow_draw_y[0], down_arrow_texture_x, down_arrow_texture_y, 14, 8, 28, 16);
      recipe_ingredients.drawIngredient(itemRenderer, matrix, 2, leftPos + ingredient_draw_x[2], topPos + ingredient_draw_y[2]);
    }
    if(length >= 4){
      draw(matrix, arrow_draw_x[3], arrow_draw_y[0], down_arrow_texture_x, down_arrow_texture_y, 14, 8, 28, 16);
      recipe_ingredients.drawIngredient(itemRenderer, matrix, 3, leftPos + ingredient_draw_x[3], topPos + ingredient_draw_y[3]);
    }
    if(length >= 5){
      draw(matrix, arrow_draw_x[0], arrow_draw_y[1],   up_arrow_texture_x,   up_arrow_texture_y, 14, 8, 28, 16);
      recipe_ingredients.drawIngredient(itemRenderer, matrix, 4, leftPos + ingredient_draw_x[4], topPos + ingredient_draw_y[4]);
    }
    if(length >= 6){
      draw(matrix, arrow_draw_x[1], arrow_draw_y[1],   up_arrow_texture_x,   up_arrow_texture_y, 14, 8, 28, 16);
      recipe_ingredients.drawIngredient(itemRenderer, matrix, 5, leftPos + ingredient_draw_x[5], topPos + ingredient_draw_y[5]);
    }
    if(length >= 7){
      draw(matrix, arrow_draw_x[2], arrow_draw_y[1],   up_arrow_texture_x,   up_arrow_texture_y, 14, 8, 28, 16);
      recipe_ingredients.drawIngredient(itemRenderer, matrix, 6, leftPos + ingredient_draw_x[6], topPos + ingredient_draw_y[6]);
    }
    if(length >= 8){
      draw(matrix, arrow_draw_x[3], arrow_draw_y[1],   up_arrow_texture_x,   up_arrow_texture_y, 14, 8, 28, 16);
      recipe_ingredients.drawIngredient(itemRenderer, matrix, 7, leftPos + ingredient_draw_x[7], topPos + ingredient_draw_y[7]);
    }
  }
